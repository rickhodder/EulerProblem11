...
public class GridProductTestsFinal
{
    private ITestOutputHelper _output;

    const string _testGrid = @"08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
    ...
    public GridProductTestsFinal(ITestOutputHelper output)
    {
        _output = output;
    }
